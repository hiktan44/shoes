...
export const DICT = {
  ...
  'pricing.usage.photo': { tr: 'Fotoğraf / Stüdyo Çekimi', en: 'Photo / Studio Shoot' },
  'pricing.usage.design': { tr: 'AI Tasarım (sıfırdan model)', en: 'AI Design (from scratch model)' },
  'pricing.usage.pose': { tr: 'Çoklu Poz (her poz)', en: 'Multi Pose (each pose)' },
  'pricing.usage.album': { tr: 'Albüm / Kolaj', en: 'Album / Collage' },
  'pricing.usage.retouch': { tr: 'Rötuş (hedefli düzenleme)', en: 'Retouch (targeted editing)' },
  'pricing.usage.analyze': { tr: 'E-Ticaret Analizi', en: 'E-Commerce Analysis' },
  'pricing.features.photo': { tr: '✓ Fotoğraf & Stüdyo Çekimi', en: '✓ Photo & Studio Shoot' },
  'pricing.features.design': { tr: '✓ AI Sıfırdan Tasarım', en: '✓ AI Design from Scratch' },
  'pricing.features.pose': { tr: '✓ Çoklu Poz Kataloğu (8 poz)', en: '✓ Multi Pose Catalog (8 poses)' },
  'pricing.features.album': { tr: '✓ Albüm / Kolaj Üretimi', en: '✓ Album / Collage Production' },
  'pricing.features.retouch': { tr: '✓ Hedefli Rötuş (maske + referans)', en: '✓ Targeted Retouch (mask + reference)' },
  'pricing.features.analyze': { tr: '✓ E-Ticaret Derin Analizi', en: '✓ E-Commerce Deep Analysis' },
  'pricing.features.neverExpire': { tr: '✓ Krediler hiç bitmez', en: '✓ Credits never expire' },
  ...
  // Analyze Page
  'analyze.title': { tr: 'Ürün Analizi', en: 'Product Analysis' },
  'analyze.description': { tr: 'Bir ayakkabı görseli yükle, e-ticaret listemesi için detaylı çıktı al.', en: 'Upload a shoe image and get detailed output for e-commerce listing.' },
  'analyze.upload': { tr: 'Görsel Yükle', en: 'Upload Image' },
  'analyze.clear': { tr: 'Temizle', en: 'Clear' },
  'analyze.outputLanguage': { tr: 'Çıktı Dili', en: 'Output Language' },
  'analyze.turkish': { tr: 'Türkçe', en: 'Turkish' },
  'analyze.english': { tr: 'English', en: 'English' },
  'analyze.analyzeButton': { tr: 'Analiz Et', en: 'Analyze' },
  'analyze.placeholder': { tr: 'Görsel yükle → "Analiz Et" → ürün listesi çıktısı burada görünecek.', en: 'Upload image → "Analyze" → product listing output will appear here.' },
  'analyze.copied': { tr: 'kopyalandı ✓', en: 'copied ✓' },
  'analyze.copyFailed': { tr: 'Kopyalama başarısız', en: 'Copy failed' },

  // Contact Page
  'contact.title': { tr: 'İletişim', en: 'Contact' },

  // Batch Page
  'batch.title': { tr: 'Toplu Üretim', en: 'Batch Production' },
  'batch.description': { tr: '30&apos;a kadar ayakkabı yükle, seçtiğin pozlar her birine uygulanır. Aynı model + aynı kıyafet kilidi otomatik aktif.', en: 'Upload up to 30 shoes, selected poses will be applied to each one. Same model + same outfit lock is automatically active.' },
  'batch.upload': { tr: 'Görsel(ler) Yükle', en: 'Upload Image(s)' },
  'batch.shoes': { tr: 'ayakkabı', en: 'shoes' },
  'batch.type': { tr: 'Tip', en: 'Type' },
  'batch.aspect': { tr: 'Aspect', en: 'Aspect' },
  'batch.autoPair': { tr: 'Tek tekli ayakkabıyı otomatik çift yap', en: 'Automatically pair single shoes' },
  'batch.zipError': { tr: 'ZIP hatası', en: 'ZIP error' },
  'batch.produceButton': { tr: 'Toplu Üret', en: 'Batch Produce' },
  'batch.images': { tr: 'görsel', en: 'images' },
  'batch.cancelButton': { tr: 'İptal Et', en: 'Cancel' },
  'batch.placeholder': { tr: 'Soldan ayakkabı(lar) yükle ve poz seç → "Toplu Üret" → her ayakkabı için durum burada gerçek zamanlı görünür.', en: 'Upload shoe(s) from left and select poses → "Batch Produce" → real-time status for each shoe appears here.' },
  'batch.progress': { tr: 'İlerleme', en: 'Progress' },
  'batch.stage1': { tr: 'Stage 1', en: 'Stage 1' },
  'batch.cancelled': { tr: 'İptal edildi', en: 'Cancelled' },
} as const;
